...
?><div class="container">
    ...
    <div id="profile-photo" class="account-settings-form col-sm-3">
	<!--<hr />-->
...
<div id="change-pass" class="account-settings-form col-sm-3">
...
<div id="update-profile" class="account-settings-form col-sm-3">
	<form action="account_settings.php" method="post">
...
<div id="close-account" class="account-settings-form col-sm-3">
